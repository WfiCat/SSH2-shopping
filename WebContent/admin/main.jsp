...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			...
			<!-- 欢迎使用小张商城后台管理系统 -->
			<c:choose>
			<c:when test="${(not empty currentUser)&&(currentUser.status==2) }">
				<strong>欢迎管理员 ${currentUser.userName } 进入后台管理！</strong>
			</c:when>
			<c:otherwise>
				<script type="text/javascript">
...
<div region="south" style="height: 25px;padding: 5px;" align="center">
	湖北工程学院 0163017042班 张帅<a href="http://www.baidu.com" target="_blank">www.baidu.com</a>
</div>
